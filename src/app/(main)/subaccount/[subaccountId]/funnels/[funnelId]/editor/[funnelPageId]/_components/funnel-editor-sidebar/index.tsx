...
import { useEditor } from "@/lib/providers/editor/editor-provider";
          ...
          <div className="grid gap-4 h-full pb-36 overflow-scroll">
            <TabsContent value="Settings">
              <SheetHeader className="text-left p-6">
                ...
                <SheetDescription>
                  Show your creativity! You can customize every componet as you
                  like.
                </SheetDescription>
              </SheetHeader>
              <SettingsTab />
            ...
            <TabsContent value="Components">
              <SheetHeader className="text-left p-6 ">
                <SheetTrigger>Components</SheetTrigger>
                <SheetDescription>
