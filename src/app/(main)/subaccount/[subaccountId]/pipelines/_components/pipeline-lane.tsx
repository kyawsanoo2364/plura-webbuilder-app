...
import { LaneDetail, TicketAndTags, TicketWithTags } from "@/lib/types";
...
const PipelineLane = ({
  ...
  const handleEditLane = async () => {
    setOpen(
      <CustomModal title="Edit Lane Details" subheading="">
        <LaneForm pipelineId={pipelineId} defaultData={laneDetail} />
      </CustomModal>
    );
  };
  ...
  return (
    <Draggable draggableId={laneDetail.id} index={index} key={laneDetail.id}>
      {(provided, snapshot) => {
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        delete your account and remove your data from our severs
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
