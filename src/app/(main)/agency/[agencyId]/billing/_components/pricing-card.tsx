...
const PricingCard = ({
  ...
  return (
    <Card className="flex  flex-col lg:w-1/2 justify-between">
      <div>
        <CardHeader className="flex flex-col md:!flex-row justify-between">
          ...
          <p className="text-6xl flex  font-bold">
            {amt}
            <small className="text-xs mt-10 font-light text-muted-foreground">
              {duration}
            </small>
          </p>
        </CardHeader>
